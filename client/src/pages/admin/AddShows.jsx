...
const AddShows = () => {
    ...
    return nowPlayingMovies.length > 0 ? (
        ...
        {/* price amount from here on input */}
        <div className='mt-8'>
                <label className='block tect-sm font-medium mb-2'>Show Price</label>
        ...
        <div className='mt-6'>
            <label className='block text-sm font-medium mb-2'>Select Date and Time </label>
                ...
                <button onClick={handleDataTimeAdd}
        ...
        <button className='bg-primary text-white px-8 py-2 mt-6 rounded hover:big-primary/90 transition-all cursor-pointer'>
        Add Show</button>
        </>
    ): <Loading />
}
