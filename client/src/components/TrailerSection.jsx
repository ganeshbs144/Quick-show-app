...
const [currentTrailer,setCurrentTrailer] = useState(dummyTrailers[0])
    ...
    return (
        ...
        <div className='relative mt-6'>
            ...
            <ReactPlayer playing={true} url={currentTrailer.videoUrl} controls={true} 
            className='mx-auto max-w-full' width='960px' height="540px" />
        </div>
        <div className='group grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
           {dummyTrailers.map((trailer) => (
            <div key={trailer.image} className='relative group-hover:opacity-50 hover:-translate-y-1 duration-300 transition max-md:h-60 md:max-h-60 cursor-pointer '
