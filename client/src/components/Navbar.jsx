...
const Navbar = () => {
    // this variable is used so that the side-navbar is not opened directly when the screen is small but when the button is clicked (XIcon)
